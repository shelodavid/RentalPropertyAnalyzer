...
- **Cash to close**: Uses Purchase Sheet totals when available; otherwise uses downpayment + Investment Profile closing costs with prepaids defaulting to 0 and marks the value as estimated.
